...
import { AriaTimeFieldProps, TimeValue, useDateSegment, useObjectRef, useTimeField } from 'react-aria'
import { DateSegmentProps } from 'react-aria-components'
import { DateFieldState, useTimeFieldState } from 'react-stately'
...
const TimeField = forwardRef(
  ({ intent = 'primary', size = 'md', ...props }: AriaTimeFieldProps<TimeValue> & Variants, ref: ForwardedRef<HTMLInputElement>) => {
    const { label } = props
